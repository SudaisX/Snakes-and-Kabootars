...
nodes = [i for i in range(1, 101)] #nodes of all the tiles
#(node, edge, (x, y))
edges = [(1, 2, (0, 0)), (2, 3, (0, 0)), (3, 4, (0, 0)), (4, 5, (0, 0)), (5, 6, (0, 0)), (6, 7, (0, 0)), (7, 8, (0, 0)), (8, 9, (0, 0)), (9, 10, (0, 0)), 
...
ladders = [] #edges for all the ladders
