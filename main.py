...
background = background = pygame.image.load(
    'images/backgrounds/newboard.png')  # ('Location of the background image')
...
class Player():
    """
    Player class, blits at (0,0) by default; no args
    """
...
# (node, edge, (x, y)) #To-do, let's set this based on calculations and variables, so that adjustments are easy to make
